...
async def iqchn():
    ...
    try:
        ...
        await iqthon(JoinChannelRequest("@UP_UH"))
    except BaseException:
        pass
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(            "تخزين تليثون زد إي العام", iqthon, Config.TG_BOT_USERNAME, descript  ,  iqphoto1 )
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        _, groupid = await create_supergroup(            "تخزين تليثون زد إي الخاص", iqthon, Config.TG_BOT_USERNAME, descript    , iqphoto2  )
