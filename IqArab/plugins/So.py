...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = "❬ تـليثون زد إي - Telethon-ZE ، 🕸  ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"⚘︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس تليثون @UI_XB :**\n\n{o}")
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , """⚘︙ جـاري تـحديث تليثـون زد إي (8.2)
...
async def update_owner(event):
    if event.sender_id == 5650717789:
        ...
        await update_msg.edit("""⚘︙ جـاري تـحديث تليثـون زد إي (8.2)
    ⌚ انتضر من 5 الى 10 دقائق""")
        try:
            ulist = get_collectionlist_items()
            for i in ulist:
...
https://t.me/UI_XT/103
• لكيفيه حذف الفار اضغط هنا ↶
https://t.me/UI_XT/97

قناة الكلايش  : @UI_XT
قناه شروحات الاوامر  : @L3LL3
قناه المتغيرات او الفارات : @UI3I3""")
    ...
    if vname in vlist:
        ...
        if cmd == "اضف":
            if not vinfo and vname == "ALIVE_TEMPLATE":
                return await edit_delete(event, f"**⚘︙  📑 يرجى متابع قناه الفارات تجدها هنا : @UI3I3")
...
async def variable(var):
    ...
    if exe == "get":
        ...
        await ics.edit(f"**⌔** `{variable}`  **تم حذفه بنجاح. \n**يتم الان اعـادة تشغيـل بـوت بوت زد إي يستغـرق الامر 2-1 دقيقـه ▬▭ ...**")
...
———————×———————**
CH : @UI_XB
⚘︙ يوجد شرح مفصل عن الامر هنا : https://t.me/UI3I3/33
""")
...
انتبة الامر بل تاء مربوطة ( ة ) وليس ( ه  )
———————×———————
 ⚘︙ يوجد شرح مفصل عن الامر هنا : https://t.me/UI3I3/17
""")
...
https://t.me/UI_XT/97
———————×——————— 
قناه المتغيرات او الفارات : @UI_XT 
شرح الأوامر : ( @UI3I3 ) .
قناه السورس : ( @UP_UO ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
الشرح :   يضيفلك جميع الاعضاء الي برابط الكروب يضيفهم بكروبك 
 ———————×———————
يوجد شرح بتفصيل هنا : https://t.me/UI3I3/16
شرح الأوامر : ( @UI3I3 ) .
قناه السورس : ( @UI_XB ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
———————×———————
يوجد شرح مفصل للتكرار هنا : https://t.me/UI3I3/19
قناه السورس : ( @UI_XB ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
✐ :  يعطيك رموز للزخرفه2 
———————×———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/UI3I3/20
""")



control_owner_id = 5650717789
...
———————×———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/UI3I3/36  ⦒
""")
...
———————×———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/UI3I3/25  ⦒
""")
...
@check_owner
async def inlineiqthon(iqthon):
    text = "**⚘︙ قـائمـه الاوامـر :**\n**⚘︙ قنـاه السـورس :** @UI_XB\n**⚘︙ شـرح اوامـر السـورس : @UI3I3**\n**⚘︙ شـرح فـارات السـورس : @UI_XT** "
    buttons = [[Button.inline("اوامر السورس", data="order1"), Button.inline("اوامر الحساب", data="ord1hs"),],[Button.inline("اوامر الكروب", data="ord1G"), Button.inline("اوامر الالعاب", data="ord1pl"),],[Button.inline("اوامر الصيغ", data="ordsag1"), Button.inline("اوامر الاغاني", data="ordSONG"),], [Button.inline("اسم وقتي", data="order13"), Button.inline("اوامر الاعلانات", data="ordahln1"),],[Button.inline("اوامر التسليه", data="order14"),],[Button.inline("الفارات", data="ordvars"),]]
    await iqthon.edit(text, buttons=buttons)
